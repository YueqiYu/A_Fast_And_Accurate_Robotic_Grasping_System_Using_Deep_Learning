...
model_dir                   = fullfile(pwd, 'output1', 'faster_rcnn_final', 'faster_rcnn_VOC0712_ZF'); %% ZF
%model_dir                   = fullfile(pwd,'faster_rcnn_final');
...
%% -------------------- TESTING --------------------
im_names = {'000111.jpg'};%, '004545.jpg', '000542.jpg', '000456.jpg', '001150.jpg'};
...
%    ld                          = load('output/faster_rcnn_final/faster_rcnn_VOC0712_ZF/model.mat');
